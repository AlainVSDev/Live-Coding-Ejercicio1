...
Me toco trabajar con mi compañera Aura. La sesion se dividio en 2 partes la primera Aura comenzo compartiendo pantalla y realizo el primer ejercicio y posteriormente continuamos con migo

Comentario de Aura: Alain muestra claridad en su pensamiento y lógica al programar, lo que se refleja en la forma en que estructura su código, que es limpio y depurado. En la segunda tarea, demostró comprender la lógica de la programación y comenzó a estructurarla con éxito. Además, no tuvo problemas al clonar y manejar el repositorio

Comentario mio hacia Aura: Aura demuestra habilidad al escribir codigo, tiene definido que herramientas usar asi como la estructura correcta, sabe explicar bien lo que esta haciendo, logrando asi cumplir el objetivo. 
